...
def populate(n):
    genders = ['male', 'female']
    package_choices = ['Basic', 'Advance', 'Gold', 'Premium']
    # Population script loop
    for entry in range(n):
        # -----------------------------------------------------------------------------------------------------
        # Populating Package Script
        profile = fake.profile()
        package_name = random.choice(package_choices)
        try:
            package_saved_data = User.objects.get(name=package_name)
        except:
