    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_details_submission_datetime', models.DateTimeField(blank=True, null=True)),
                ('payment_datetime', models.DateTimeField(blank=True, null=True)),
                ('unit_purchase_price', models.FloatField(default=0.0)),
                ('portrage_price', models.FloatField(blank=True, null=True)),
                ...
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='order.supplier')),
            ],
        ),
        migrations.CreateModel(
            name='OrderDetail',
